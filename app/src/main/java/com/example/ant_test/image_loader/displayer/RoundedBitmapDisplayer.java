...
/**
 * @Title: RoundBitmapDisplayer.java
 * @Package com.example.ant_test.image_loader.displayer
 * @Description: TODO(description)
 * @author Chenxiao
 * @date 2014-9-29 下午4:35:35
 * @version V1.0
 * @company East Money Information Co., Ltd.
 */
public class RoundedBitmapDisplayer implements IBitmapDisplayer{
	...
	@Override
	public void display(Bitmap bitmap, IImageWrapper wrapper, LoadedFrom loadedFrom) {
		if (!(wrapper instanceof ImageViewWrapper)) {
			throw new IllegalArgumentException("ImageAware should wrap ImageView. ImageViewAware is expected.");
		}
		wrapper.setImageDrawable(new RoundedDrawable(bitmap, cornerRadius, margin));
	}
	...
	public static class RoundedDrawable extends Drawable {
		...
		protected void onBoundsChange(Rect bounds) {
			...
			//把mBitmapRectmBitmapRect映射到mRect，不保持原来的宽高比
